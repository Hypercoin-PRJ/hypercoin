...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef HYPERCOIN_CHAINPARAMSSEEDS_H\n')
    g.write('#define HYPERCOIN_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the hypercoin network\n')
    ...
    g.write('#endif // HYPERCOIN_CHAINPARAMSSEEDS_H\n')
