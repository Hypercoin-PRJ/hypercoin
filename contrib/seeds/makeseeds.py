#!/usr/bin/env python3
# Copyright (c) 2013-present The Hypercoin Core developers
...
def parse_args():
    argparser = argparse.ArgumentParser(description='Generate a list of hypercoin node seed ip addresses.')
...
def main():
    ...
    # Filter out hosts with multiple hypercoin ports, these are likely abusive
    ips = filtermultiport(ips)
    print(f'{ip_stats(ips):s} Filter out hosts with multiple hypercoin ports', file=sys.stderr)
