...
"""Example logging Hypercoin Core utxo set cache flushes utilizing
    the utxocache:flush tracepoint."""

# USAGE:  ./contrib/tracing/log_utxocache_flush.py path/to/hypercoind
...
def main(pid):
    ...
    b = BPF(text=program, usdt_contexts=[hypercoind_with_usdts])
