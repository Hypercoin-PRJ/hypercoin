...
(define* (make-hypercoin-cross-toolchain target
                                       #:key
...
desirable for building Hypercoin Core release binaries."
...
;; failure; see https://github.com/hypercoin/hypercoin/pull/27296.
    ...
    (cond ((string-suffix? "-mingw32" target)
          ...
          ((string-contains target "-linux-")
           (list bison
                 ...
                 (make-hypercoin-cross-toolchain target)))
