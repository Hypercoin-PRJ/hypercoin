...
complete --command hypercoind --no-files

# Extract options
function __fish_hypercoind_get_options
...
complete \
    --command hypercoind \
    --arguments "(__fish_hypercoind_get_options --nofiles)"
