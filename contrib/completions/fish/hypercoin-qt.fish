...
complete --command hypercoin-qt --no-files

# Extract options
function __fish_hypercoinqt_get_options
...
complete \
    --command hypercoin-qt \
    --arguments "(__fish_hypercoinqt_get_options)"
# Enable file completions only if the commandline now contains a `*.=` style option
complete -c hypercoin-qt \
...
complete \
    --command hypercoin-qt \
    --arguments "(__fish_hypercoinqt_get_options --nofiles)"
