...
# Extract options
function __fish_hypercoin_tx_get_options
...
# Extract commands
function __fish_hypercoin_tx_get_commands
...
# Add options
complete \
    --command hypercoin-tx \
    --condition "not __fish_hypercoin_seen_cmd (__fish_hypercoin_tx_get_commands --commandsonly)" \
    --arguments "(__fish_hypercoin_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command hypercoin-tx \
    --arguments "(__fish_hypercoin_tx_get_commands)" \
    --no-files
