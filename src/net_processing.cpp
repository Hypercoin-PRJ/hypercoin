...
void PeerManagerImpl::PushNodeVersion(CNode& pnode, const Peer& peer)
{
    ...
    if (pnode.IsPrivateBroadcastConn()) {
        ...
        your_addr = CService{};
        my_user_agent = "/pynode:0.0.1/"; // Use a constant other than the default (or user-configured). See https://github.com/hypercoin/hypercoin/pull/27509#discussion_r1214671917
        my_height = 0;
        my_tx_relay = false;
    } else {
...
void PeerManagerImpl::ProcessGetData(CNode& pfrom, Peer& peer, const std::atomic<bool>& interruptMsgProc)
{
    ...
    if (it != peer.m_getdata_requests.end() && !pfrom.fPauseSend) {
        ...
        // https://hypercoincore.org/en/2024/07/03/disclose-getdata-cpu.
    }
...
// hours with specially crafted transactions. See https://hypercoincore.org/en/2024/07/03/disclose-orphan-dos.
