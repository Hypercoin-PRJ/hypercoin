...
#ifndef HYPERCOIN_TXREQUEST_H
#define HYPERCOIN_TXREQUEST_H
 ...
 *   specific transaction. See https://hypercoincore.org/en/2024/07/03/disclose_already_asked_for.
 */
