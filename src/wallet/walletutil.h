// Copyright (c) 2017-2021 The Hypercoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef HYPERCOIN_WALLET_WALLETUTIL_H
#define HYPERCOIN_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! hypercoin from opening the wallet, thinking it was newly created, and
...
#endif // HYPERCOIN_WALLET_WALLETUTIL_H
