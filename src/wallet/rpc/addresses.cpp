...
RPCHelpMan getnewaddress()
{
    return RPCHelpMan{
        ...
        "Returns a new Hypercoin address for receiving payments.\n"
                ...
                RPCResult{
                    RPCResult::Type::STR, "address", "The new hypercoin address"
                },
                RPCExamples{
...
RPCHelpMan setlabel()
{
    return RPCHelpMan{
        ...
        "Sets the label associated with the given address.\n",
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The hypercoin address to be associated with a label."},
                ...
                RPCResult{
                    RPCResult::Type::ARR, "", "",
                    {
                        {RPCResult::Type::ARR, "", "",
                        {
                            ...
                            {
                                {RPCResult::Type::STR, "address", "The hypercoin address"},
...
RPCHelpMan getaddressinfo()
{
    return RPCHelpMan{
        ...
        "Return information about the given hypercoin address.\n"
                ...
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The hypercoin address for which to get information."},
                },
                RPCResult{
                    RPCResult::Type::OBJ, "", "",
                    {
                        {RPCResult::Type::STR, "address", "The hypercoin address validated."},
...
RPCHelpMan walletdisplayaddress()
{
    return RPCHelpMan{
        ...
        {
            {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "hypercoin address to display"},
        },
        RPCResult{
            RPCResult::Type::OBJ,"","",
            {
