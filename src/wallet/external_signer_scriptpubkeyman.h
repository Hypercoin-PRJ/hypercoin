...
#ifndef HYPERCOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define HYPERCOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // HYPERCOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
