...
#ifndef HYPERCOIN_WALLET_WALLET_H
#define HYPERCOIN_WALLET_WALLET_H
...
public:
     ...
     * hypercoin-wallet tool code or by wallet migration code. If this is called
...
#endif // HYPERCOIN_WALLET_WALLET_H
