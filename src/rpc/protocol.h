...
#ifndef HYPERCOIN_RPC_PROTOCOL_H
#define HYPERCOIN_RPC_PROTOCOL_H
...
enum RPCErrorCode
{
    ...
    // RPC_INTERNAL_ERROR should only be used for genuine errors in hypercoind
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //!< Hypercoin is not connected
...
#endif // HYPERCOIN_RPC_PROTOCOL_H
