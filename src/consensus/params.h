...
#ifndef HYPERCOIN_CONSENSUS_PARAMS_H
#define HYPERCOIN_CONSENSUS_PARAMS_H
...
struct Params {
    ...
    /**
     * If true, witness commitments contain a payload equal to a Hypercoin Script solution
...
#endif // HYPERCOIN_CONSENSUS_PARAMS_H
