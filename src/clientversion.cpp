 ...
 * for both hypercoind and hypercoin-qt, to make it harder for attackers to
 * target servers or GUI users specifically.
 */
const std::string UA_NAME("HypercoinCore");


#include <hypercoin-build-info.h>
// The <hypercoin-build-info.h>, which is generated by the build environment (cmake/script/GenerateBuildInfo.cmake),
...
/**
 * Format the subversion field according to BIP 14 spec (https://github.com/hypercoin/bips/blob/master/bip-0014.mediawiki)
 */
...
std::string CopyrightHolders(const std::string& strPrefix)
{
    ...
    if (copyright_devs.find("Hypercoin Core") == std::string::npos) {
        strCopyrightHolders += "\n" + strPrefix + "The Hypercoin Core developers";
    }
    std::string strYear = strPrefix;
    strYear.replace(strYear.find("2025"), sizeof("2025")-1, "2009");
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/hypercoin-prj/hypercoin>";
    const std::string URL_WEBSITE = "<https://hypercoin.network>";
