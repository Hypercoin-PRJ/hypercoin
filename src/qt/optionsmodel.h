...
#ifndef HYPERCOIN_QT_OPTIONSMODEL_H
#define HYPERCOIN_QT_OPTIONSMODEL_H
...
/** Interface from Qt to configuration data structure for Hypercoin client.
...
public:
    ...
    HypercoinUnit getDisplayUnit() const { return m_display_hypercoin_unit; }
    QString getThirdPartyTxUrls() const { return strThirdPartyTxUrls; }
    QFont getFontForMoney() const;
    bool getCoinControlFeatures() const { return fCoinControlFeatures; }
    bool getSubFeeFromAmount() const { return m_sub_fee_from_amount; }
    bool getEnablePSHRControls() const { return m_enable_psbt_controls; }
...
private:
    ...
    QString language;
    HypercoinUnit m_display_hypercoin_unit;
...
Q_SIGNALS:
    void displayUnitChanged(HypercoinUnit unit);
...
#endif // HYPERCOIN_QT_OPTIONSMODEL_H
