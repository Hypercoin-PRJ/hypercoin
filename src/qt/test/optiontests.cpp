...
{
    // Test regression https://github.com/hypercoin/hypercoin/issues/24457. Ensure
...
{
    // Test that the bug https://github.com/hypercoin-core/gui/issues/567 does not resurface.
    // It was fixed via https://github.com/hypercoin-core/gui/pull/568.
    // With fListen=false in ~/.config/Hypercoin/Hypercoin-Qt.conf and all else left as default,
    // hypercoin-qt should set both -listen and -listenonion to false and start successfully.
