...
//
//     src/qt/test/test_hypercoin-qt -platform xcb      # Linux
//     src/qt/test/test_hypercoin-qt -platform windows  # Windows
//     src/qt/test/test_hypercoin-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = HypercoinUnits::formatWithUnit(unit, balance, false, HypercoinUnits::separatorAlways);
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: hypercoin:")) != -1);
