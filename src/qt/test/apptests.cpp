...
//! Entry point for HypercoinApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &HypercoinApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for HypercoinGUI tests.
void AppTests::guiTests(HypercoinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &HypercoinGUI::consoleShown, this, &AppTests::consoleTests);
