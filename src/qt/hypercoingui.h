...
#ifndef HYPERCOIN_QT_HYPERCOINGUI_H
#define HYPERCOIN_QT_HYPERCOINGUI_H
...
/**
  Hypercoin GUI main class. This class represents the main window of the Hypercoin UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class HypercoinGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit HypercoinGUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = nullptr);
    ~HypercoinGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a hypercoin wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
public Q_SLOTS:
    ...
    void incomingTransaction(const QString& date, HypercoinUnit unit, const CAmount& amount, const QString& type, const QString& address, const QString& label, const QString& walletName);
#endif // ENABLE_WALLET
...
public Q_SLOTS:
    ...
    /** Load Partially Signed Hypercoin Transaction from file or clipboard */
...
private Q_SLOTS:
    ...
    void updateDisplayUnit(HypercoinUnit newUnits);
    /** Tells underlying optionsModel to update its current display unit. */
    void onMenuSelection(QAction* action);
};

#endif // HYPERCOIN_QT_HYPERCOINGUI_H
