...
#include <qt/hypercoingui.h>

#include <qt/hypercoinunits.h>
 ...
 *
 * Ref: https://github.com/hypercoin/hypercoin/pull/1026
 */
static constexpr int64_t MAX_BLOCK_TIME_GAP = 90 * 60;

const std::string HypercoinGUI::DEFAULT_UIPLATFORM =
...
HypercoinGUI::HypercoinGUI(interfaces::Node& node, const PlatformStyle *_platformStyle, const NetworkStyle *networkStyle, QWidget *parent) :
    QMainWindow(parent),
    m_node(node),
    ...
    m_network_style(networkStyle)
{
    ...
    if(enableWallet)
    {
        ...
        connect(walletFrame, &WalletFrame::createWalletButtonClicked, this, &HypercoinGUI::createWallet);
    ...
    connect(labelBlocksIcon, &GUIUtil::ClickableLabel::clicked, this, &HypercoinGUI::showModalOverlay);
    connect(progressBar, &GUIUtil::ClickableProgressBar::clicked, this, &HypercoinGUI::showModalOverlay);
...
void HypercoinGUI::createActions()
{
    ...
    connect(overviewAction, &QAction::triggered, this, &HypercoinGUI::gotoOverviewPage);
    connect(sendCoinsAction, &QAction::triggered, [this]{ showNormalIfMinimized(); });
    connect(sendCoinsAction, &QAction::triggered, [this]{ gotoSendCoinsPage(); });
    connect(receiveCoinsAction, &QAction::triggered, [this]{ showNormalIfMinimized(); });
    connect(receiveCoinsAction, &QAction::triggered, this, &HypercoinGUI::gotoReceiveCoinsPage);
    connect(historyAction, &QAction::triggered, [this]{ showNormalIfMinimized(); });
    connect(historyAction, &QAction::triggered, this, &HypercoinGUI::gotoHistoryPage);
#endif // ENABLE_WALLET
    ...
    m_load_psbt_action->setStatusTip(tr("Load Partially Signed Hypercoin Transaction"));
    m_load_psbt_clipboard_action = new QAction(tr("Load PSBT from &clipboard…"), this);
    m_load_psbt_clipboard_action->setStatusTip(tr("Load Partially Signed Hypercoin Transaction from clipboard"));
    ...
    openAction->setStatusTip(tr("Open a hypercoin: URI"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible Hypercoin command-line options").arg(CLIENT_NAME));
    ...
    connect(quitAction, &QAction::triggered, this, &HypercoinGUI::quitRequested);
    connect(aboutAction, &QAction::triggered, this, &HypercoinGUI::aboutClicked);
    connect(aboutQtAction, &QAction::triggered, qApp, QApplication::aboutQt);
    connect(optionsAction, &QAction::triggered, this, &HypercoinGUI::optionsClicked);
    connect(showHelpMessageAction, &QAction::triggered, this, &HypercoinGUI::showHelpMessageClicked);
    connect(openRPCConsoleAction, &QAction::triggered, this, &HypercoinGUI::showDebugWindow);
    ...
    if(walletFrame)
    {
        ...
        connect(openAction, &QAction::triggered, this, &HypercoinGUI::openClicked);
        connect(m_open_wallet_menu, &QMenu::aboutToShow, [this] {
            ...
            for (const auto& [path, info] : m_wallet_controller->listWalletDir()) {
                ...
                connect(action, &QAction::triggered, [this, path] {
                    ...
                    connect(activity, &OpenWalletActivity::opened, this, &HypercoinGUI::setCurrentWallet, Qt::QueuedConnection);
        ...
        connect(m_restore_wallet_action, &QAction::triggered, [this] {
            ...
            connect(activity, &RestoreWalletActivity::restored, this, &HypercoinGUI::setCurrentWallet, Qt::QueuedConnection);
        ...
        connect(m_create_wallet_action, &QAction::triggered, this, &HypercoinGUI::createWallet);
        ...
        connect(m_migrate_wallet_menu, &QMenu::aboutToShow, [this] {
            ...
            for (const auto& [wallet_name, info] : m_wallet_controller->listWalletDir()) {
                ...
                connect(action, &QAction::triggered, [this, wallet_name] {
                    ...
                    connect(activity, &MigrateWalletActivity::migrated, this, &HypercoinGUI::setCurrentWallet);
        ...
        connect(m_mask_values_action, &QAction::toggled, this, &HypercoinGUI::setPrivacy);
        connect(m_mask_values_action, &QAction::toggled, this, &HypercoinGUI::enableHistoryAction);
    }
#endif // ENABLE_WALLET

    connect(new QShortcut(QKeySequence(Qt::CTRL | Qt::SHIFT | Qt::Key_C), this), &QShortcut::activated, this, &HypercoinGUI::showDebugWindowActivateConsole);
    connect(new QShortcut(QKeySequence(Qt::CTRL | Qt::SHIFT | Qt::Key_D), this), &QShortcut::activated, this, &HypercoinGUI::showDebugWindow);
}

void HypercoinGUI::createMenuBar()
{
    appMenuBar = menuBar();
...
void HypercoinGUI::createToolBars()
{
    if(walletFrame)
    {
        ...
        connect(m_wallet_selector, qOverload<int>(&QComboBox::currentIndexChanged), this, &HypercoinGUI::setCurrentWalletBySelectorIndex);
...
void HypercoinGUI::setClientModel(ClientModel *_clientModel, interfaces::BlockAndHeaderTipInfo* tip_info)
{
    ...
    if(_clientModel)
    {
        ...
        connect(_clientModel, &ClientModel::numConnectionsChanged, this, &HypercoinGUI::setNumConnections);
        connect(_clientModel, &ClientModel::networkActiveChanged, this, &HypercoinGUI::setNetworkActive);
        ...
        connect(_clientModel, &ClientModel::numBlocksChanged, this, &HypercoinGUI::setNumBlocks);
        ...
        connect(_clientModel, &ClientModel::showProgress, this, &HypercoinGUI::showProgress);
...
#ifdef ENABLE_WALLET
void HypercoinGUI::enableHistoryAction(bool privacy)
{
...
void HypercoinGUI::setWalletController(WalletController* wallet_controller, bool show_loading_minimized)
{
    ...
    GUIUtil::ExceptionSafeConnect(wallet_controller, &WalletController::walletAdded, this, &HypercoinGUI::addWallet);
    connect(wallet_controller, &WalletController::walletRemoved, this, &HypercoinGUI::removeWallet);
...
WalletController* HypercoinGUI::getWalletController()
{
    return m_wallet_controller;
}

void HypercoinGUI::addWallet(WalletModel* walletModel)
{
    ...
    connect(wallet_view, &WalletView::outOfSyncWarningClicked, this, &HypercoinGUI::showModalOverlay);
    connect(wallet_view, &WalletView::transactionClicked, this, &HypercoinGUI::gotoHistoryPage);
    connect(wallet_view, &WalletView::coinsSent, this, &HypercoinGUI::gotoHistoryPage);
    connect(wallet_view, &WalletView::message, [this](const QString& title, const QString& message, unsigned int style) {
        this->message(title, message, style);
    });
    connect(wallet_view, &WalletView::encryptionStatusChanged, this, &HypercoinGUI::updateWalletStatus);
    connect(wallet_view, &WalletView::incomingTransaction, this, &HypercoinGUI::incomingTransaction);
    connect(this, &HypercoinGUI::setPrivacy, wallet_view, &WalletView::setPrivacy);
    wallet_view->setPrivacy(isPrivacyModeActivated());
    const QString display_name = walletModel->getDisplayName();
    m_wallet_selector->addItem(display_name, QVariant::fromValue(walletModel));
}

void HypercoinGUI::removeWallet(WalletModel* walletModel)
{
...
void HypercoinGUI::setCurrentWallet(WalletModel* wallet_model)
{
    if (!walletFrame || !m_wallet_controller) return;
...
void HypercoinGUI::setCurrentWalletBySelectorIndex(int index)
{
    WalletModel* wallet_model = m_wallet_selector->itemData(index).value<WalletModel*>();
    if (wallet_model) setCurrentWallet(wallet_model);
}

void HypercoinGUI::removeAllWallets()
{
    if(!walletFrame)
        return;
    setWalletActionsEnabled(false);
...
void HypercoinGUI::setWalletActionsEnabled(bool enabled)
{
...
void HypercoinGUI::createTrayIcon()
{
...
void HypercoinGUI::createTrayIconMenu()
{
#ifndef Q_OS_MACOS
    if (!trayIcon) return;
#endif // Q_OS_MACOS
    ...
    show_hide_action = trayIconMenu->addAction(QString(), this, &HypercoinGUI::toggleHidden);
...
void HypercoinGUI::optionsClicked()
{
    openOptionsDialogWithTab(OptionsDialog::TAB_MAIN);
}

void HypercoinGUI::aboutClicked()
{
    if(!clientModel)
        return;
...
void HypercoinGUI::showDebugWindow()
{
    GUIUtil::bringToFront(rpcConsole);
    Q_EMIT consoleShown(rpcConsole);
}

void HypercoinGUI::showDebugWindowActivateConsole()
{
    rpcConsole->setTabFocus(RPCConsole::TabTypes::CONSOLE);
    showDebugWindow();
}

void HypercoinGUI::showHelpMessageClicked()
{
    GUIUtil::bringToFront(helpMessageDialog);
}

#ifdef ENABLE_WALLET
void HypercoinGUI::openClicked()
{
...
void HypercoinGUI::gotoOverviewPage()
{
    overviewAction->setChecked(true);
    if (walletFrame) walletFrame->gotoOverviewPage();
}

void HypercoinGUI::gotoHistoryPage()
{
    historyAction->setChecked(true);
    if (walletFrame) walletFrame->gotoHistoryPage();
}

void HypercoinGUI::gotoReceiveCoinsPage()
{
    receiveCoinsAction->setChecked(true);
    if (walletFrame) walletFrame->gotoReceiveCoinsPage();
}

void HypercoinGUI::gotoSendCoinsPage(QString addr)
{
    sendCoinsAction->setChecked(true);
    if (walletFrame) walletFrame->gotoSendCoinsPage(addr);
}

void HypercoinGUI::gotoSignMessageTab(QString addr)
{
    if (walletFrame) walletFrame->gotoSignMessageTab(addr);
}

void HypercoinGUI::gotoVerifyMessageTab(QString addr)
{
    if (walletFrame) walletFrame->gotoVerifyMessageTab(addr);
}
void HypercoinGUI::gotoLoadPSBT(bool from_clipboard)
{
    if (walletFrame) walletFrame->gotoLoadPSBT(from_clipboard);
}
#endif // ENABLE_WALLET

void HypercoinGUI::updateNetworkState()
{
    ...
    if (m_node.getNetworkActive()) {
        ...
        tooltip = tr("%n active connection(s) to Hypercoin network.", "", count);
    } else {
        //: A substring of the tooltip.
...
void HypercoinGUI::setNumConnections(int count)
{
    updateNetworkState();
}

void HypercoinGUI::setNetworkActive(bool network_active)
{
    updateNetworkState();
...
void HypercoinGUI::updateHeadersSyncProgressLabel()
{
...
void HypercoinGUI::updateHeadersPresyncProgressLabel(int64_t height, const QDateTime& blockDate)
{
...
void HypercoinGUI::openOptionsDialogWithTab(OptionsDialog::Tab tab)
{
    if (!clientModel || !clientModel->getOptionsModel())
        return;

    auto dlg = new OptionsDialog(this, enableWallet);
    connect(dlg, &OptionsDialog::quitOnReset, this, &HypercoinGUI::quitRequested);
...
void HypercoinGUI::setNumBlocks(int count, const QDateTime& blockDate, double nVerificationProgress, SyncType synctype, SynchronizationState sync_state)
{
...
void HypercoinGUI::createWallet()
{
#ifdef ENABLE_WALLET
    auto activity = new CreateWalletActivity(getWalletController(), this);
    connect(activity, &CreateWalletActivity::created, this, &HypercoinGUI::setCurrentWallet);
    connect(activity, &CreateWalletActivity::created, rpcConsole, &RPCConsole::setCurrentWallet);
    activity->create();
#endif // ENABLE_WALLET
}

void HypercoinGUI::message(const QString& title, QString message, unsigned int style, bool* ret, const QString& detailed_message)
{
...
void HypercoinGUI::changeEvent(QEvent *e)
{
    ...
    if(e->type() == QEvent::WindowStateChange)
    {
        if(clientModel && clientModel->getOptionsModel() && clientModel->getOptionsModel()->getMinimizeToTray())
        {
            ...
            {
                QTimer::singleShot(0, this, &HypercoinGUI::hide);
                e->ignore();
            }
            else if((wsevt->oldState() & Qt::WindowMinimized) && !isMinimized())
            {
                QTimer::singleShot(0, this, &HypercoinGUI::show);
                e->ignore();
            }
        }
    }
...
void HypercoinGUI::closeEvent(QCloseEvent *event)
{
#ifndef Q_OS_MACOS // Ignored on Mac
    if(clientModel && clientModel->getOptionsModel())
    {
...
void HypercoinGUI::showEvent(QShowEvent *event)
{
...
#ifdef ENABLE_WALLET
void HypercoinGUI::incomingTransaction(const QString& date, HypercoinUnit unit, const CAmount& amount, const QString& type, const QString& address, const QString& label, const QString& walletName)
{
    // On new transaction, make an info balloon
    QString msg = tr("Date: %1\n").arg(date) +
                  tr("Amount: %1\n").arg(HypercoinUnits::formatWithUnit(unit, amount, true));
...
void HypercoinGUI::dragEnterEvent(QDragEnterEvent *event)
{
    // Accept only URIs
...
void HypercoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
...
bool HypercoinGUI::eventFilter(QObject *object, QEvent *event)
{
...
#ifdef ENABLE_WALLET
bool HypercoinGUI::handlePaymentRequest(const SendCoinsRecipient& recipient)
{
    // URI has to be valid
...
void HypercoinGUI::setHDStatus(bool privkeyDisabled, int hdEnabled)
{
...
void HypercoinGUI::setEncryptionStatus(int status)
{
    switch(status)
    {
...
void HypercoinGUI::updateWalletStatus()
{
    assert(walletFrame);
...
void HypercoinGUI::updateProxyIcon()
{
    std::string ip_port;
...
void HypercoinGUI::updateWindowTitle()
{
...
void HypercoinGUI::showNormalIfMinimized(bool fToggleHidden)
{
    if(!clientModel)
        return;
...
void HypercoinGUI::toggleHidden()
{
    showNormalIfMinimized(true);
}

void HypercoinGUI::detectShutdown()
{
...
void HypercoinGUI::showProgress(const QString &title, int nProgress)
{
    if (nProgress == 0) {
...
void HypercoinGUI::showModalOverlay()
{
    if (modalOverlay && (progressBar->isVisible() || modalOverlay->isLayerVisible()))
        modalOverlay->toggleVisibility();
}

static bool ThreadSafeMessageBox(HypercoinGUI* gui, const bilingual_str& message, unsigned int style)
{
    ...
    if (message.original != message.translated) {
        detailed_message = HypercoinGUI::tr("Original message:") + "\n" + QString::fromStdString(message.original);
    }
...
void HypercoinGUI::subscribeToCoreSignals()
{
...
void HypercoinGUI::unsubscribeFromCoreSignals()
{
...
bool HypercoinGUI::isPrivacyModeActivated() const
{
    ...
    : m_platform_style{platformStyle}
{
    ...
    QList<HypercoinUnit> units = HypercoinUnits::availableUnits();
    int max_width = 0;
    const QFontMetrics fm(font());
    for (const HypercoinUnit unit : units) {
        max_width = qMax(max_width, GUIUtil::TextWidth(fm, HypercoinUnits::longName(unit)));
    }
...
{
    menu = new QMenu(this);
    for (const HypercoinUnit u : HypercoinUnits::availableUnits()) {
        menu->addAction(HypercoinUnits::longName(u))->setData(QVariant::fromValue(u));
    }
...
void UnitDisplayStatusBarControl::updateDisplayUnit(HypercoinUnit newUnits)
{
    setText(HypercoinUnits::longName(newUnits));
}
