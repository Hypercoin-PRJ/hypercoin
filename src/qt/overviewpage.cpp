...
public:
                      ...
                      const QModelIndex &index ) const override
    {
        ...
        painter->setPen(foreground);
        QString amountText = HypercoinUnits::formatWithUnit(unit, amount, true, HypercoinUnits::SeparatorStyle::ALWAYS);
        if(!confirmed)
        {
    ...
    HypercoinUnit unit{HypercoinUnit::HRC};
...
{
    HypercoinUnit unit = walletModel->getOptionsModel()->getDisplayUnit();
    ui->labelBalance->setText(HypercoinUnits::formatWithPrivacy(unit, balances.balance, HypercoinUnits::SeparatorStyle::ALWAYS, m_privacy));
    ui->labelUnconfirmed->setText(HypercoinUnits::formatWithPrivacy(unit, balances.unconfirmed_balance, HypercoinUnits::SeparatorStyle::ALWAYS, m_privacy));
    ui->labelImmature->setText(HypercoinUnits::formatWithPrivacy(unit, balances.immature_balance, HypercoinUnits::SeparatorStyle::ALWAYS, m_privacy));
    ui->labelTotal->setText(HypercoinUnits::formatWithPrivacy(unit, balances.balance + balances.unconfirmed_balance + balances.immature_balance, HypercoinUnits::SeparatorStyle::ALWAYS, m_privacy));
