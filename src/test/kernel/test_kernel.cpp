...
#include <kernel/hypercoinkernel_wrapper.h>
#include <util/fs.h>

#define BOOST_TEST_MODULE Hypercoin Kernel Test Suite
...
BOOST_AUTO_TEST_CASE(hrck_transaction_tests)
{
...
BOOST_AUTO_TEST_CASE(hrck_script_pubkey)
{
...
BOOST_AUTO_TEST_CASE(hrck_transaction_output)
{
...
BOOST_AUTO_TEST_CASE(hrck_transaction_input)
{
...
BOOST_AUTO_TEST_CASE(hrck_precomputed_txdata) {
    auto tx_data{hex_string_to_byte_vec("")};
    auto tx{Transaction{tx_data}};
    auto tx_data_2{hex_string_to_byte_vec("")};
    auto tx2{Transaction{tx_data_2}};
...
BOOST_AUTO_TEST_CASE(hrck_script_verify_tests)
{
...
{
    hrck_LoggingOptions logging_options = {
        .log_timestamps = true,
...
BOOST_AUTO_TEST_CASE(hrck_context_tests)
{
...
BOOST_AUTO_TEST_CASE(hrck_block_header_tests)
{
...
BOOST_AUTO_TEST_CASE(hrck_block)
{
...
BOOST_AUTO_TEST_CASE(hrck_chainman_tests)
{
    Logger logger{std::make_unique<TestLog>()};
    auto test_directory{TestDirectory{"chainman_test_hypercoin_kernel"}};
...
BOOST_AUTO_TEST_CASE(hrck_chainman_mainnet_tests)
{
    auto test_directory{TestDirectory{"mainnet_test_hypercoin_kernel"}};
...
BOOST_AUTO_TEST_CASE(hrck_block_hash_tests)
{
...
BOOST_AUTO_TEST_CASE(hrck_block_tree_entry_tests)
{
    auto test_directory{TestDirectory{"block_tree_entry_test_hypercoin_kernel"}};
    auto notifications{std::make_shared<TestKernelNotifications>()};
...
BOOST_AUTO_TEST_CASE(hrck_chainman_in_memory_tests)
{
    auto in_memory_test_directory{TestDirectory{"in-memory_test_hypercoin_kernel"}};
...
BOOST_AUTO_TEST_CASE(hrck_chainman_regtest_tests)
{
    auto test_directory{TestDirectory{"regtest_test_hypercoin_kernel"}};
