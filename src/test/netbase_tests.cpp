...
{
    BOOST_CHECK(TestSplitHost("www.hypercoincore.org", "www.hypercoincore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.hypercoincore.org]", "www.hypercoincore.org", 0));
    BOOST_CHECK(TestSplitHost("www.hypercoincore.org:80", "www.hypercoincore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.hypercoincore.org]:80", "www.hypercoincore.org", 80));
    ...
    BOOST_CHECK(TestSplitHost("www.hypercoincore.org:65536", "www.hypercoincore.org:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.hypercoincore.org:0", "www.hypercoincore.org", 0, false));
    BOOST_CHECK(TestSplitHost("www.hypercoincore.org:", "www.hypercoincore.org:", 0, false));
}
