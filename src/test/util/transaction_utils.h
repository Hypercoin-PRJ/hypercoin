// Copyright (c) 2019-2020 The Hypercoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef HYPERCOIN_TEST_UTIL_TRANSACTION_UTILS_H
#define HYPERCOIN_TEST_UTIL_TRANSACTION_UTILS_H
...
#endif // HYPERCOIN_TEST_UTIL_TRANSACTION_UTILS_H
