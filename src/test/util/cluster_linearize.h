...
#ifndef HYPERCOIN_TEST_UTIL_CLUSTER_LINEARIZE_H
#define HYPERCOIN_TEST_UTIL_CLUSTER_LINEARIZE_H
    ...
    void Unser(Stream& s, DepGraph<SetType>& depgraph)
    {
        ...
        while (true) {
            ...
            try {
                ...
                uint64_t coded_fee;
                s >> VARINT(coded_fee);
                coded_fee &= 0xFFFFFFFFFFFFF; // Enough for fee between -21M...21M HRC.
...
#endif // HYPERCOIN_TEST_UTIL_CLUSTER_LINEARIZE_H
