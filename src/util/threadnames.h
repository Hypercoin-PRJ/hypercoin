// Copyright (c) 2018-2019 The Hypercoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef HYPERCOIN_UTIL_THREADNAMES_H
#define HYPERCOIN_UTIL_THREADNAMES_H
...
#endif // HYPERCOIN_UTIL_THREADNAMES_H
