...
// Copyright (c) 2009-2023 The Hypercoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef HYPERCOIN_UTIL_FS_HELPERS_H
#define HYPERCOIN_UTIL_FS_HELPERS_H
...
#endif // HYPERCOIN_UTIL_FS_HELPERS_H
