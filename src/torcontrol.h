// Copyright (c) 2015-2021 The Hypercoin Core developers
 ...
 */
#ifndef HYPERCOIN_TORCONTROL_H
#define HYPERCOIN_TORCONTROL_H
...
/****** Hypercoin specific TorController implementation ********/
