...
#ifndef HYPERCOIN_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
#define HYPERCOIN_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
...
#endif // HYPERCOIN_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
