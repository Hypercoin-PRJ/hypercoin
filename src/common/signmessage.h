...
#ifndef HYPERCOIN_COMMON_SIGNMESSAGE_H
#define HYPERCOIN_COMMON_SIGNMESSAGE_H
 ...
 * @param[in] address Signer's hypercoin address, it must refer to a public key.
...
#endif // HYPERCOIN_COMMON_SIGNMESSAGE_H
