...
#ifndef HYPERCOIN_TXGRAPH_H
#define HYPERCOIN_TXGRAPH_H
 ...
 *
 * For more explanation, see https://delvinghypercoin.org/t/introduction-to-cluster-linearization/1032
 *
