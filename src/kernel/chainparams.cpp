...
// Copyright (c) 2025 The Hypercoin Core developers
...
{
    const char* pszTimestamp = "Nature is very pretty";
    const CScript genesisOutputScript = CScript() << "0490d785143f32041396681b7cd0e3161f32548e8635e6891275ce77d8c1ca63d7f4705e1cedb21f1de70d45d9d5758b620cb7f8e6abbf68e6162b2bf374bb5be7"_hex << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.script_flag_exceptions.emplace( 
            uint256{"00000fd27173f747f0c3ecef47f696c5ab9fd25d274fad590a069d54d66235be"}, SCRIPT_VERIFY_NONE);
        consensus.script_flag_exceptions.emplace( 
            uint256{"00000fd27173f747f0c3ecef47f696c5ab9fd25d274fad590a069d54d66235be"}, SCRIPT_VERIFY_P2SH | SCRIPT_VERIFY_WITNESS);
        consensus.BIP34Height = 15;
        consensus.BIP34Hash = uint256{"00000fd27173f747f0c3ecef47f696c5ab9fd25d274fad590a069d54d66235be"};
        consensus.BIP65Height = 15; 
        ...
        consensus.nMinimumChainWork = uint256{"00000c6a5bd2c2c81af3a3b83bb16a664782bb573ca50f13ea65f2214307b1b3"};
        consensus.defaultAssumeValid = uint256{"3723ed6c9443386ba5e1808d4dd97a2ffd8e917d7c7c264c3f01ce5655a87ef6"};
        ...
        genesis = CreateGenesisBlock(1769139074, 305665, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256{"00000c6a5bd2c2c81af3a3b83bb16a664782bb573ca50f13ea65f2214307b1b3"});
        assert(genesis.hashMerkleRoot == uint256{"3723ed6c9443386ba5e1808d4dd97a2ffd8e917d7c7c264c3f01ce5655a87ef6"});

        vSeeds.emplace_back("seed01.hypercoin.network"); 
        vSeeds.emplace_back("seed02.hypercoin.network");
        vSeeds.emplace_back("seed03.hypercoin.network"); 
        vSeeds.emplace_back("seed04.hypercoin.network"); 
        vSeeds.emplace_back("seed05.hypercoin.network");  
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1769139124, 913495, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256{"00000de0772db23ec69f7201199f61af5e25a2da2474821b7fab2da6e6c856ab"});
        assert(genesis.hashMerkleRoot == uint256{"3723ed6c9443386ba5e1808d4dd97a2ffd8e917d7c7c264c3f01ce5655a87ef6"});

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.emplace_back("tseed01.hypercoin.network");
        vSeeds.emplace_back("tseed02.hypercoin.network");
...
public:
    CTestNet4Params() {
        ...
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        //vSeeds.emplace_back("seed.testnet4.hypercoin.sprovoost.nl."); // Sjors Provoost
...
public:
    explicit SigNetParams(const SigNetOptions& options)
    {
        ...
        if (!options.challenge) {
            ...
            vSeeds.emplace_back("seed.signet.hypercoin.sprovoost.nl.");
        ...
        genesis = CreateGenesisBlock(1769139161, 618861, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256{"00000e658fc6b48549c1231a531bf8c0737cb3b40e0006d8070b2940451e9be2"});
        assert(genesis.hashMerkleRoot == uint256{"3723ed6c9443386ba5e1808d4dd97a2ffd8e917d7c7c264c3f01ce5655a87ef6"});
...
public:
    explicit CRegTestParams(const RegTestOptions& opts)
    {
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256{"71542288530365a8adffef062d6ad5cf7e1d755e02b71af0b653383928609cbe"});
        assert(genesis.hashMerkleRoot == uint256{"3723ed6c9443386ba5e1808d4dd97a2ffd8e917d7c7c264c3f01ce5655a87ef6"});
