...
//! that can be used internally by functions in the libhypercoin_kernel library,
...
#ifndef HYPERCOIN_KERNEL_TYPES_H
#define HYPERCOIN_KERNEL_TYPES_H
...
#endif // HYPERCOIN_KERNEL_TYPES_H
