...
#ifndef HYPERCOIN_TXMEMPOOL_H
#define HYPERCOIN_TXMEMPOOL_H
 ...
 * Hypercoin-specific logic. Specifically, TxGraph handles (for each transaction)
 ...
 *
 * CTxMemPool itself handles the Hypercoin-specific parts of mempool
