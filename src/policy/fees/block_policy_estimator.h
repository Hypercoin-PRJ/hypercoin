...
#ifndef HYPERCOIN_POLICY_FEES_BLOCK_POLICY_ESTIMATOR_H
#define HYPERCOIN_POLICY_FEES_BLOCK_POLICY_ESTIMATOR_H
...
#endif // HYPERCOIN_POLICY_FEES_BLOCK_POLICY_ESTIMATOR_H
