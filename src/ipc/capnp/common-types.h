...
#ifndef HYPERCOIN_IPC_CAPNP_COMMON_TYPES_H
#define HYPERCOIN_IPC_CAPNP_COMMON_TYPES_H
...
//! needed to pass transaction objects between hypercoin processes.
...
//! Functions to serialize / deserialize common hypercoin types.
namespace mp {
...
#endif // HYPERCOIN_IPC_CAPNP_COMMON_TYPES_H
