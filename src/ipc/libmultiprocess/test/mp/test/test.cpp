...
{
    // Regression test for hypercoin/hypercoin#34711, hypercoin/hypercoin#34756 where a
...
{
    // Regression test for hypercoin/hypercoin#34777 heap-use-after-free where
...
{
    // Regression test for hypercoin/hypercoin#34782 stack-use-after-return where
