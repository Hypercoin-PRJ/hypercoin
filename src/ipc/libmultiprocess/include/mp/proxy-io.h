...
extern thread_local ThreadContext g_thread_context; // NOLINT(hypercoin-nontrivial-threadlocal)
// Silence nonstandard hypercoin tidy error "Variable with non-trivial destructor
