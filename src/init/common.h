...
//! @file
//! @brief Common init functions shared by hypercoin-node, hypercoin-wallet, etc.

#ifndef HYPERCOIN_INIT_COMMON_H
#define HYPERCOIN_INIT_COMMON_H
