...
//
// The hypercoin-chainstate executable serves to surface the dependencies required
// by a program wishing to use Hypercoin Core's consensus engine as it is right
// now.
//
// DEVELOPER NOTE: Since this is a "demo-only", experimental, etc. executable,
//                 it may diverge from Hypercoin Core's coding style.
//
// It is part of the libhypercoinkernel project.
