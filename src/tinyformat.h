...
#include <algorithm>
#include <attributes.h> // Added for Hypercoin Core
#include <iostream>
#include <sstream>
#include <stdexcept> // Added for Hypercoin Core
#include <util/string.h> // Added for Hypercoin Core
...
// Added for Hypercoin Core. Similar to std::runtime_format from C++26.
...
// Added for Hypercoin Core. Wrapper for checking format strings at compile time.
