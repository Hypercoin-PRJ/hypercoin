...
#ifndef HYPERCOIN_INTERFACES_INIT_H
#define HYPERCOIN_INTERFACES_INIT_H
...
//! (hypercoin-gui, hypercoin-node, hypercoin-wallet, hypercoind, hypercoin-qt) and each
...
#endif // HYPERCOIN_INTERFACES_INIT_H
