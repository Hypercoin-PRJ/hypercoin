...
#ifndef HYPERCOIN_INTERFACES_NODE_H
#define HYPERCOIN_INTERFACES_NODE_H
...
//! Top-level interface for a hypercoin node (hypercoind process).
class Node
{
public:
    ...
    //! Return setting value from <datadir>/settings.json or hypercoin.conf.
...
#endif // HYPERCOIN_INTERFACES_NODE_H
