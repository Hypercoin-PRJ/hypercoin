...
class TestShell:
    """Wrapper Class for HypercoinTestFramework.

    The TestShell class extends the HypercoinTestFramework
    ...
    class __TestShell(HypercoinTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by HypercoinTestFramework child class.
            self.num_nodes = 1
    ...
    def __new__(cls):
        ...
        if not TestShell.instance:
            # HypercoinTestFramework instances are supposed to be constructed with the path
