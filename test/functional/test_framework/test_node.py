...
class TestNode():
    ...
    def assert_start_raises_init_error(self, extra_args=None, expected_msg=None, match=ErrorMatch.FULL_TEXT, *args, **kwargs):
        ...
        Will raise if hypercoind starts without an error.
        Will raise if an expected_msg is provided and it does not match hypercoind's stdout."""
