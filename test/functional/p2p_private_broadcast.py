...
class P2PPrivateBroadcast(HypercoinTestFramework):
    ...
    def run_test(self):
        ...
        # Stop the SOCKS5 proxy server to avoid it being upset by the hypercoin
        ...
        self.restart_node(0, extra_args=[
            ...
            # Hypercoin Core to start, hoping/assuming that the location of the Tor proxy
