...
class MempoolAcceptanceTest(HypercoinTestFramework):
    ...
    def run_test(self):
        ...
        # Settings are listed in HRC/kvB
        ...
        self.mempool_size = 0
        # Also check feerate. 1HRC/kvB fails
        assert_raises_rpc_error(-8, "Fee rates larger than or equal to 1HRC/kvB are not accepted", lambda: self.check_mempool_result(
        ...
        utxo_to_spend = self.wallet.get_utxo(txid=txid_in_block)  # use 0.3 HRC UTXO
