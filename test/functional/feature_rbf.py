...
class ReplaceByFeeTest(HypercoinTestFramework):
    ...
    def test_simple_doublespend(self):
        ...
        reject_details = f"{reject_reason}, rejecting replacement {tx.txid_hex}; new feerate 0.00300000 HRC/kvB <= old feerate 0.00300000 HRC/kvB"
    ...
    def test_doublespend_chain(self):
        ...
        # child fees - 4 HRC - so this attempt is rejected.
