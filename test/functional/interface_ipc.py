...
class IPCInterfaceTest(HypercoinTestFramework):
    ...
    def run_unclean_disconnect_test(self):
        ...
        reported https://github.com/hypercoin/hypercoin/issues/34250, but now just
    ...
    def run_thread_busy_test(self):
        ...
        https://github.com/hypercoin/hypercoin/issues/33923."""
        node = self.nodes[0]
