...
class P2PFeelerReceiver(P2PInterface):
    def on_version(self, message):
        # The hypercoind node closes feeler connections as soon as a version
...
class P2PAddConnections(HypercoinTestFramework):
    ...
    def run_test(self):
        ...
        # hypercoind behaves properly when a version is sent unexpectedly (but
        # tolerably) early.
        #
        # This checks that hypercoind sends its own version prior to processing
