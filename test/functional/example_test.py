...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the HypercoinTestFramework
    pass


class ExampleTest(HypercoinTestFramework):
    # Each functional test is a subclass of the HypercoinTestFramework class.
    ...
    def custom_method(self):
        ...
        HypercoinTestFramework class so other tests can use it."""
