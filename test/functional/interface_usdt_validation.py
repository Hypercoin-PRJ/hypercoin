...
""" Tests the validation:* tracepoint API interface.
    See https://github.com/hypercoin/hypercoin/blob/master/doc/tracing.md#context-validation
"""
...
class ValidationTracepointTest(HypercoinTestFramework):
    ...
    def run_test(self):
        ...
        # blocks.
        # See https://github.com/hypercoin/hypercoin/blob/master/doc/tracing.md#tracepoint-validationblock_connected
