...
class WalletLabelsTest(HypercoinTestFramework):
    ...
    def test_label_named_parameter_handling(self):
        ...
        self.log.info("Test hypercoin-cli -named passes parameter containing '=' by position if it does not specify a known parameter name and is in a string position")
    ...
    def run_test(self):
        ...
        # each with 1 address with a balance of 50 Hypercoins
