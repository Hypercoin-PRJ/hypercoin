...
export CONTAINER_NAME=ci_native_nowallet_libhypercoinkernel
...
export GOAL="install"
export HYPERCOIN_CONFIG="-DREDUCE_EXPORTS=ON -DBUILD_UTIL_CHAINSTATE=ON -DBUILD_KERNEL_LIB=ON -DBUILD_SHARED_LIBS=ON"
