...
def print_version():
    hypercoind = Path.cwd() / "bin" / "hypercoind.exe"
    run([str(hypercoind), "-version"])
...
def run_functional_tests():
    ...
    test_runner_cmd = [
        ...
        *shlex.split(os.environ.get("TEST_RUNNER_EXTRA", "").strip()),
        ...
        # See https://github.com/hypercoin/hypercoin/issues/31409.
        "--exclude",
