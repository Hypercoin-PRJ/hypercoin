...
Hypercoin Core version 31.0.0 is now available from:
...
(on Windows) or just copy over `/Applications/Hypercoin-Qt` (on macOS) or
...
migrated. Old wallet versions of Hypercoin Core are generally supported.

Compatibility
==============

Hypercoin Core is supported and tested on the following operating systems or
newer: Linux Kernel 3.17, macOS 14, and Windows 10 (version 1903). Hypercoin Core
should also work on most other Unix-like systems but is not as frequently tested
on them. It is not recommended to use Hypercoin Core on unsupported systems.

Hypercoin 31.0.0 Change log
===============
...
`-dbcache=450`. See
[reduce-memory.md](https://github.com/hypercoin/hypercoin/blob/master/doc/reduce-memory.md)
...
than the original. See [delvinghypercoin.org
post](https://delvinghypercoin.org/t/an-overview-of-the-cluster-mempool-proposal/393#rbf-can-now-be-made-incentive-compatible-for-miners-11)
...
[doc/policy/mempool-terminology.md](https://github.com/hypercoin/hypercoin/blob/master/doc/policy/mempool-terminology.md)
and
[doc/policy/mempool-replacements.md](https://github.com/hypercoin/hypercoin/blob/master/doc/policy/mempool-replacements.md).
...
created on 2026-03-05](https://github.com/hypercoin/hypercoin/pull/34696). Despite
...
being deprecated in Hypercoin Core 30.0. They used to allow the user to set a
...
The Hypercoin Core fee estimator minimum fee rate bucket was updated from **1
