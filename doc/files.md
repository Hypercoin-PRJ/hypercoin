...
* hypercoin.conf: contains configuration settings for hypercoind or hypercoin-qt
* hypercoind.pid: stores the process id of hypercoind while running
...
* debug.log: contains debug information and general logging generated by hypercoind or hypercoin-qt
