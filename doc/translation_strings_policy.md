...
This document provides guidelines for internationalization of the Hypercoin Core software.
...
This can be checked by building the `translate` target with `cmake` ([instructions](translation_process.md)), then verifying that `hypercoin_en.ts` remains unchanged.
