...
```sh
cmake --build build --target hypercoind hypercoin-cli
cmake --build build --target hypercoin-qt
cmake --build build --target bench_hypercoin
```
...
> e.g. github.com/hypercoin/hypercoin.git or for the GUI github.com/hypercoin-core/gui
