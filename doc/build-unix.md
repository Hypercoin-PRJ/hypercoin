...
To build Hypercoin Core without the wallet, see [*Disable-wallet mode*](#disable-wallet-mode)
...
Disable-wallet mode
--------------------
When the intention is to only run a P2P node, without a wallet, Hypercoin Core can
...
This example lists the steps necessary to setup and build a command line only distribution of the latest changes on Arch Linux:
    ...
    ./build/bin/hypercoind
    ./build/bin/hypercoin help
