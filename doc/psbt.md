# PSBT Howto for Hypercoin Core

Since Hypercoin Core 0.17, an RPC interface exists for Partially Signed Hypercoin
Transactions (PSBTs, as specified in
[BIP 174](https://github.com/hypercoin/bips/blob/master/bip-0174.mediawiki)).
...
PSBT is an interchange format for Hypercoin transactions that are not fully signed
...
#### Multisig with multiple Hypercoin Core instances
