...
* Only limited package replacements are currently considered. (#28984)
   ...
   - Must improve [feerate diagram](https://delvinghypercoin.org/t/mempool-incentive-compatibility/553). (#29242)
...
[TRUC transactions](https://github.com/hypercoin/bips/blob/master/bip-0431.mediawiki) as an individual
