Hypercoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/hypercoin/files/Hypercoin/hypercoin-0.5.4/
...
http://gitorious.org/hypercoin/hypercoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Hypercoin-Qt notifications under Growl 1.3.
Increase required age of Hypercoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxHypercoin properly when installing Hypercoin-Qt over it. (Windows)
