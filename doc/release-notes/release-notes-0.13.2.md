Hypercoin Core version 0.13.2 is now available from:

  <https://hypercoin.org/bin/hypercoin-core-0.13.2/>
...
- #8908 `4a974b2` Update hypercoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow hypercoin-tx to create v2 transactions (hrcdrak)
