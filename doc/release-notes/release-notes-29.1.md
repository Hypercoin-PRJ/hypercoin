Hypercoin Core version 29.1 is now available from:

  <https://hypercoincore.org/bin/hypercoin-core-29.1/>
...
- #32389 doc: Fix test_hypercoin path
- #32607 rpc: Note in fundrawtransaction doc, fee rate is for package
- #32679 doc: update tor docs to use hypercoind binary from path
...
- #32719 doc, windows: CompanyName "Hypercoin" => "Hypercoin Core project"
