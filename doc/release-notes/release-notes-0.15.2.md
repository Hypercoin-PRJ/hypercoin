Hypercoin Core version *0.15.2* is now available from:

  <https://hypercoincore.org/bin/hypercoin-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in hypercoin-tx (TheBlueMatt)
