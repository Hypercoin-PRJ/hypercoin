Hypercoin Core version 27.0 is now available from:

  <https://hypercoincore.org/bin/hypercoin-core-27.0/>
...
libhypercoinconsensus
-------------------

- libhypercoinconsensus is deprecated and will be removed for v28. This library has
  ...
  In the future, libhypercoinkernel will provide a much more useful API that is
...
- A C++20 capable compiler is now required to build Hypercoin Core. (#28349)
...
- Various fixes to prevent issues where subsequent instances of Hypercoin Core would
