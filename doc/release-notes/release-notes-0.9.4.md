Hypercoin Core version 0.9.4 is now available from:

  https://hypercoin.org/bin/0.9.4/
...
this update is incompatible with the Hypercoin system and could lead to consensus
forks.

Hypercoin Core released binaries from https://hypercoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~hypercoin/+archive/ubuntu/hypercoin
- A third-party or self-compiled Hypercoin Core

upgrade to Hypercoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
