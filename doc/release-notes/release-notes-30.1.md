...
Hypercoin Core version v30.1 is now available from:

  <https://hypercoincore.org/bin/hypercoin-core-30.1/>
...
- #33229 multiprocess: Don't require hypercoin -m argument when IPC options are used
...
- #33723 chainparams: remove dnsseed.hypercoin.dashjr-list-of-p2p-nodes.us
