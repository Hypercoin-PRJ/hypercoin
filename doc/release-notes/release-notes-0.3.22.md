Download URL: https://sourceforge.net/projects/hypercoin/files/Hypercoin/hypercoin-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 HRC fee schedule (users still pay 0.01 HRC per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #hypercoin00 - #hypercoin99
