...
Hypercoin Core version 0.19.1 is now available from:

  <https://hypercoincore.org/bin/hypercoin-core-0.19.1/>
...
From Hypercoin Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Hypercoin Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Hypercoin Core does not yet change appearance when
...
- #17488 fix "hypercoind already running" warnings on macOS (fanquake)
