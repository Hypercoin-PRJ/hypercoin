Hypercoin Core version *0.15.0.1* is now available from:

  <https://hypercoin.org/bin/hypercoin-core-0.15.0.1/>

and

  <https://hypercoincore.org/bin/hypercoin-core-0.15.0.1/>
