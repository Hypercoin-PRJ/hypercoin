Hypercoin Core version 0.10.4 is now available from:

  <https://hypercoin.org/bin/hypercoin-core-0.10.4/>
...
- #6953 `43c2789` Split hypercoin-tx into its own package
- #6953 `dfe0d4d` Include hypercoin-tx binary on Debian/Ubuntu
