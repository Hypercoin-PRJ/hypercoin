Hypercoin Core version 0.9.2.1 is now available from:

  https://hypercoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 HRC to 0.01 HRC
...
- Fix "Start hypercoin on system login"
