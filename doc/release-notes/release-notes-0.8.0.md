Hypercoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/hypercoin/files/Hypercoin/hypercoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Hypercoin
...
New/changed settings (command-line or hypercoin.conf file)
--------------------------------------------------------
