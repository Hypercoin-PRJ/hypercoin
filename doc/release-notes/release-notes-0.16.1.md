Hypercoin Core version 0.16.1 is now available from:

  <https://hypercoincore.org/bin/hypercoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting hypercoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure hypercoind processes are cleaned up when tests end (sdaftuar)
