...
([`valgrind.supp`](https://github.com/hypercoin/hypercoin/blob/master/contrib/valgrind.supp))
which includes known Valgrind warnings in our dependencies that cannot be fixed
in-tree. Example use:

```shell
$ valgrind --suppressions=contrib/valgrind.supp build/bin/test_hypercoin
...
- [HTTP worker threads(`b-httpworker.x`)](https://doxygen.hypercoincore.org/httpserver_8cpp.html#aa6a7bc27265043bc0193220c5ae3a55f)
