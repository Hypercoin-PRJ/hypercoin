...
Assumeutxo is a feature that allows fast bootstrapping of a validating hypercoind
instance.
...
```
$ hypercoin-cli -rpcclienttimeout=0 loadtxoutset /path/to/input
```
...
```
$ hypercoin-cli -rpcclienttimeout=0 dumptxoutset /path/to/output rollback
```
