...
function(extract_strings output)
  ...
  file(STRINGS "hypercoinstrings.po" text ENCODING "UTF-8")
...
static const char UNUSED *hypercoin_strings[] = {
  ...
  set(prefix "QT_TRANSLATE_NOOP(\"hypercoin-core\", \"")
  set(suffix "\"),\n")
...
extract_strings("${PROJECT_SOURCE_DIR}/src/qt/hypercoinstrings.cpp"
...
execute_process(
  COMMAND ${LUPDATE_EXECUTABLE}
    ...
    ${PROJECT_SOURCE_DIR}/src/qt/hypercoinstrings.cpp
    -ts ${PROJECT_SOURCE_DIR}/src/qt/locale/hypercoin_en.ts
  COMMAND_ERROR_IS_FATAL ANY
)
...
execute_process(
  COMMAND ${LCONVERT_EXECUTABLE}
    -drop-translations
    -o ${PROJECT_SOURCE_DIR}/src/qt/locale/hypercoin_en.xlf
    -i ${PROJECT_SOURCE_DIR}/src/qt/locale/hypercoin_en.ts
  COMMAND_ERROR_IS_FATAL ANY
)

file(READ "${PROJECT_SOURCE_DIR}/src/qt/locale/hypercoin_en.xlf" hypercoin_en)
string(REPLACE "source-language=\"en\" target-language=\"en\""
  "source-language=\"en\"" hypercoin_en "${hypercoin_en}"
)
string(REGEX REPLACE " *<target xml:space=\"preserve\"></target>\n"
  "" hypercoin_en "${hypercoin_en}"
)
file(WRITE "${PROJECT_SOURCE_DIR}/src/qt/locale/hypercoin_en.xlf" "${hypercoin_en}")
